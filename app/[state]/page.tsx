        ...
        <main className="max-w-3xl mx-auto pt-[52px]">
          ...
          <header className="px-6 pt-12 pb-8">
            ...
            <div className="flex gap-4 mt-8">
              <div className="flex-1 bg-[#f5f5f7] rounded-2xl p-5 text-center">
          ...
          <section className="px-6 py-8">
            <h2 className="text-[#1d1d1f] text-xl font-semibold mb-6">
            ...
            <div className="space-y-3">
              {activeCities.map(city => (
                <Link
                  ...
                  className="flex items-center justify-between bg-[#f5f5f7] rounded-xl p-4 hover:bg-[#e8e8ed] transition-colors group"
                >
                  <div>
              ...
              <div className="mt-8 pt-6 border-t border-[#d2d2d7]/50">
                ...
                <div className="flex flex-wrap gap-2">
                  {comingSoonCities.map(city => (
                    <span
                      key={city.id}
                      className="text-sm px-3 py-1.5 bg-[#f5f5f7] text-[#86868b] rounded-full"
                    >
                      {city.name}
                    </span>
                  ))}
