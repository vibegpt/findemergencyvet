...
// Legacy route — permanently redirected to canonical /{state-slug}/{city}
// The [state] param here was a lowercase abbreviation (e.g. "ny"),
// so we map it to the full slug before redirecting.
export default async function LegacyLocationsCityRedirect({
  params,
}: {
  ...
  permanentRedirect(`/${stateSlug}/${city}`)
}
