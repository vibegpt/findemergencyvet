...
export default function StateCityPage({
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <main className="max-w-3xl mx-auto pt-[60px]">
        ...
        <header className="px-5 pt-12 pb-8">
          <div className="flex items-center gap-1.5 text-[13px] text-[#86868B] mb-6">
            ...
            <span>&rsaquo;</span>
            <Link href={`/states/${stateSlug}`} className="hover:text-[#1D1D1F] transition-colors">{stateName}</Link>
            <span>&rsaquo;</span>
          ...
          {allClinics.length === 0 && (
            <div className="border-2 border-dashed border-[#E8E8ED] rounded-2xl p-10 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#F5F5F7] text-[#1D1D1F] font-medium rounded-xl hover:bg-[#E8E8ED] transition-colors"
              >
                Search Google Maps
              </a>
            </div>
        ...
        <section className="mx-5 mb-8 bg-[#FFF3E0] border border-[#FFE0B2] rounded-2xl p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[#1D1D1F] text-sm font-semibold mb-1">
                Think your pet was poisoned?
              </p>
              <p className="text-[#6E6E73] text-sm">
                Call the ASPCA Animal Poison Control Center:{' '}
                <a href="tel:8884264435" className="font-bold underline whitespace-nowrap text-[#1D1D1F]">(888) 426-4435</a>
                <span className="text-[#86868B] text-xs ml-1">(consultation fee may apply)</span>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-5 py-8 bg-[#F5F5F7] border-t border-[#E8E8ED]">
      ...
      {/* Mobile Bottom Nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-[#E8E8ED] px-6 py-2.5 pb-[max(0.625rem,env(safe-area-inset-bottom))]" style={{ background: 'rgba(250,250,250,0.9)', backdropFilter: 'saturate(180%) blur(20px)', WebkitBackdropFilter: 'saturate(180%) blur(20px)' }} aria-label="Bottom navigation">
